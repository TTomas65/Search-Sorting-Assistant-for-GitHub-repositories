...
// Log that someone tried to use the legacy login
logError('Legacy login attempt', 'Redirecting to GitHub login');

// Return an error message informing that only GitHub login is now supported
$response = [
    'success' => false,
    'message' => 'Password-based login is no longer supported. Please use Sign in with GitHub.',
